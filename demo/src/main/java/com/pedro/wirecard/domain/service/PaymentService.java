...
public class PaymentService implements IPaymentService {
    ...
    public PaymentService(PaymentRepository paymentRepository, ICardService cardService, IBuyerService buyerService) {
    ...
    public void isBuyerValid(Buyer purchaseBuyer) throws CpfNotFoundException {
        buyerService.findByBuyerCpf(purchaseBuyer.getCpf());
    }
}
